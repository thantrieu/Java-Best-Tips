...
// 1 -> 2 -> 3 -> 4 -> null
// B1: lưu địa chỉ của node head
// B2: cập nhật node head mới
// B3: giải phóng bộ nhớ của node bị xoá
// ==> done!
...
int main () {
    ...
    removeHead(&singlyLinkedList);
    printf("danh sách liên kết sau khi xoá head: \n");
    showLinkedListElement(singlyLinkedList);
    printf("\n");
